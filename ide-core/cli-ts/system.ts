...
const DEFAULT_PREFIX =
  `You are Mekong, a local multi-agent IDE assistant powered by Apple Silicon.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX =
  `You are Mekong, a local multi-agent IDE assistant, running within the Agent SDK.`
const AGENT_SDK_PREFIX =
  `You are a Mekong agent, built on the Agent SDK for local Apple Silicon inference.`
