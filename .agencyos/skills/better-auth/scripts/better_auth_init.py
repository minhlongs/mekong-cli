...
.env loading order: process.env > skill/.env > skills/.env > .agencyos/.env
"""
...
class BetterAuthInit:
    ...
    def _load_env_files(self) -> Dict[str, str]:
        ...
        Loading order: process.env > skill/.env > skills/.env > .agencyos/.env
        ...
        env_paths = [
            self.project_root / ".agencyos" / ".env",
            self.project_root / ".agencyos" / "skills" / ".env",
            skill_dir / ".env",
        ]
