...
**File:** `components/marketing/trust-bar/trust-bar.html`
**Group:** `marketing`
**Props:** `TrustBarProps extends React.HTMLAttributes<HTMLDivElement>`
...
## Usage
```jsx
import { TrustBar } from "@@ds-bundle";

<TrustBar variant="default" className="...">
  ...
</TrustBar>
```
