...
**File:** `components/pr/press-card/press-card.html`
**Group:** `pr`
**Props:** `PressCardProps extends React.HTMLAttributes<HTMLDivElement>`
...
## Usage
```jsx
import { PressCard } from "@@ds-bundle";

<PressCard variant="default" className="...">
  ...
</PressCard>
```
