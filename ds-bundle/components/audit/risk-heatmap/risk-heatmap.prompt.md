...
**File:** `components/audit/risk-heatmap/risk-heatmap.html`
**Group:** `audit`
**Props:** `RiskHeatmapProps extends React.HTMLAttributes<HTMLDivElement>`
...
## Usage
```jsx
import { RiskHeatmap } from "@@ds-bundle";

<RiskHeatmap variant="default" className="...">
  ...
</RiskHeatmap>
```
