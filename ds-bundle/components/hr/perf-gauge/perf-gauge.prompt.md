...
**File:** `components/hr/perf-gauge/perf-gauge.html`
**Group:** `hr`
**Props:** `PerfGaugeProps extends React.HTMLAttributes<HTMLDivElement>`
...
## Usage
```jsx
import { PerfGauge } from "@@ds-bundle";

<PerfGauge variant="default" className="...">
  ...
</PerfGauge>
```
