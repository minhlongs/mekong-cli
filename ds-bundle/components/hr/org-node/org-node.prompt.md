...
**File:** `components/hr/org-node/org-node.html`
**Group:** `hr`
**Props:** `OrgNodeProps extends React.HTMLAttributes<HTMLDivElement>`
...
## Usage
```jsx
import { OrgNode } from "@@ds-bundle";

<OrgNode variant="default" className="...">
  ...
</OrgNode>
```
