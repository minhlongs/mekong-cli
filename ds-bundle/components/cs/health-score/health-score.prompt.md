...
**File:** `components/cs/health-score/health-score.html`
**Group:** `cs`
**Props:** `HealthScoreProps extends React.HTMLAttributes<HTMLDivElement>`
...
## Usage
```jsx
import { HealthScore } from "@@ds-bundle";

<HealthScore variant="default" className="...">
  ...
</HealthScore>
```
