...
**File:** `components/cs/nps-gauge/nps-gauge.html`
**Group:** `cs`
**Props:** `NpsGaugeProps extends React.HTMLAttributes<HTMLDivElement>`
...
## Usage
```jsx
import { NpsGauge } from "@@ds-bundle";

<NpsGauge variant="default" className="...">
  ...
</NpsGauge>
```
