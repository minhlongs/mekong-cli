...
**File:** `components/cdp/customer-360/customer-360.html`
**Group:** `cdp`
**Props:** `Customer360Props extends React.HTMLAttributes<HTMLDivElement>`
...
## Usage
```jsx
import { Customer360 } from "@@ds-bundle";

<Customer360 variant="default" className="...">
  ...
</Customer360>
```
