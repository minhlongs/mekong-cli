---
description: description: Optimize an existing agent skill [auto]
---

# Claudekit Command: /skill-optimize-auto
...
## Your mission
Optimize an existing skill in `$HOME/.claude/skills/${SKILL}` directory. 
