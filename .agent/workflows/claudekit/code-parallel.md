---
description: description: ⚡ Execute parallel or sequential phases based on plan structure
---

# Claudekit Command: /code-parallel
...
Follow `$HOME/.claude/rules/primary-workflow.md`:
