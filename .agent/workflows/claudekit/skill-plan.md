---
description: description: Plan to create a new agent skill
---

# Claudekit Command: /skill-plan
...
## Your mission
Propose a plan to create a new skill in `$HOME/.claude/skills/${SKILL}` directory. 
