---
description: description: Create isolated git worktree for parallel development
---

# Claudekit Command: /worktree
...
Claude: [Runs: node $HOME/.claude/scripts/worktree.cjs info --json]
        [Detects: standalone repo, envFiles: [".env.example"]]
        [Detects prefix from "fix" keyword: fix]
        [Converts slug: "login-validation-bug"]
        [Runs: node $HOME/.claude/scripts/worktree.cjs create "login-validation-bug" --prefix fix]
