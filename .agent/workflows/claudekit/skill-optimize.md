---
description: description: Optimize an existing agent skill
---

# Claudekit Command: /skill-optimize
...
## Your mission
Propose a plan to optimize an existing skill in `$HOME/.claude/skills/${SKILL}` directory. 
