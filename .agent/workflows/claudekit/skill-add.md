---
description: description: Add new reference files or scripts to a skill
---

# Claudekit Command: /skill-add
...
## Your mission
Add new reference files or scripts to a skill at `$HOME/.claude/skills/$1` directory.
