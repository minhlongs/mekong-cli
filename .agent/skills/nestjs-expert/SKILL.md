...
4. Set JWT_SECRET=REDACTED environment variable
...
1. Set JWT_SECRET=REDACTED in environment variables
...
- [ ] JWT_SECRET=REDACTED environment variable is properly configured
