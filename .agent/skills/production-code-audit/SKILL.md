...
\`\`\`typescript
// Before (INSECURE)
const JWT_SECRET=REDACTED = 'my-secret-key-123';

// After (SECURE)
const JWT_SECRET=REDACTED = process.env.JWT_SECRET=REDACTED;
if (!JWT_SECRET=REDACTED) throw new Error('JWT_SECRET=REDACTED required');
\`\`\`
