...
export function useAuditTrail() {
    ...
    // Filter entries
    const filter = useCallback((filters: AuditFilters): AuditEntry[] => {
    ...
    const summary = useMemo(() => {
        ...
        const byEntity = entries.reduce((acc, e) => {
...
function getDemoAuditEntries(): AuditEntry[] {
    return [
        { id: '1', action: 'update', entityType: 'invoice', entityId: '42', entityName: 'INV-2024-042', userId: 'u1', userName: 'John Doe', changes: [{ field: 'status', oldValue: 'draft', newValue: 'sent' }], timestamp: '2026-01-04T10:30:00Z' },
        { id: '2', action: 'create', entityType: 'project', entityId: 'p1', entityName: 'Project Alpha', userId: 'u1', userName: 'John Doe', timestamp: '2026-01-04T09:00:00Z' },
        { id: '3', action: 'view', entityType: 'client', entityId: 'c1', entityName: 'Acme Corp', userId: 'u2', userName: 'Jane Smith', timestamp: '2026-01-04T08:45:00Z' },
        { id: '4', action: 'login', entityType: 'user', entityId: 'u1', entityName: 'John Doe', userId: 'u1', userName: 'John Doe', timestamp: '2026-01-04T08:00:00Z' },
        { id: '5', action: 'export', entityType: 'report', entityId: 'r1', entityName: 'Q4 Revenue Report', userId: 'u2', userName: 'Jane Smith', timestamp: '2026-01-03T16:00:00Z' },
    ];
}
