...
import { Phone, Calendar, Target, TrendingUp, Users, DollarSign } from 'lucide-react';
...
export default function SDRPage({ params: { locale } }: { params: { locale: string } }) {
    ...
    return (
        <MD3AppShell title="SDR Hub 📱" subtitle="Outreach • Prospecting • Demos • Pipeline">
            <MD3SupportingPaneLayout
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                            ...
                            <MD3Surface shape="large" className="auto-safe">
                                <div className="flex items-center gap-3 mb-2">
                                    ...
                                    <span style={{ fontSize: 'var(--md-sys-typescale-label-medium-size)', color: 'var(--md-sys-color-on-surface-variant)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Meetings Set</span>
                                </div>
                                <div style={{ fontSize: 'var(--md-sys-typescale-display-small-size)', fontWeight: 600, color: '#22c55e' }}>32</div>
                                <div style={{ fontSize: 'var(--md-sys-typescale-body-small-size)', color: 'var(--md-sys-color-tertiary)' }}>+8 booked</div>
                            </MD3Surface>
                            <MD3Surface shape="large" className="auto-safe">
                                <div className="flex items-center gap-3 mb-2">
                                ...
                                <div style={{ fontSize: 'var(--md-sys-typescale-display-small-size)', fontWeight: 600, color: '#a855f7' }}>$180K</div>
                                <div style={{ fontSize: 'var(--md-sys-typescale-body-small-size)', color: 'var(--md-sys-color-tertiary)' }}>+$32K generated</div>
                            </MD3Surface>
                            <MD3Surface shape="large" className="auto-safe">
                                <div className="flex items-center gap-3 mb-2">
                                    <Target className="w-5 h-5" style={{ color: '#f59e0b' }} />
                                    <span style={{ fontSize: 'var(--md-sys-typescale-label-medium-size)', color: 'var(--md-sys-color-on-surface-variant)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Connect Rate</span>
                                </div>
                ...
                supportingContent={
                    <MD3Card headline="Quick Actions" subhead="SDR Tools">
                        <div className="space-y-2">
                            {[{ icon: '📞', label: 'Dial' }, { icon: '📅', label: 'Book' }, { icon: '📋', label: 'Sequence' }, { icon: '🎯', label: 'Quota' }, { icon: '📊', label: 'Stats' }, { icon: '⚙️', label: 'Settings' }].map((action) => (
