        ...
        <div className="min-h-screen bg-[#020202] text-white font-mono">
            <nav className="fixed top-0 w-full z-50 border-b border-violet-500/20 bg-black/50 backdrop-blur-xl h-14 flex items-center px-6 justify-between">
                <div className="flex items-center gap-2 text-violet-400">
                    ...
                    <span className="px-1.5 py-0.5 text-[10px] bg-violet-500/20 border border-violet-500/30 rounded">PROJECTS</span>
                </div>
            ...
            <main className="pt-24 px-6 max-w-[1920px] mx-auto pb-20">
                <h1 className="text-4xl font-bold mb-8 text-violet-400">📅 Projects Dashboard</h1>
