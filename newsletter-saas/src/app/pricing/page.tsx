  ...
  const handleCheckout = async (planId: string) => {
    ...
    try {
      const res = await fetch("/api/billing/checkout", {
        ...
        body: JSON.stringify({ plan: planId, billing: interval }),
      });
      ...
      if (data.checkoutUrl) {
        ...
        alert(
          `Demo mode: Upgraded to ${planId}!\nIn production, you'd be redirected to PayPal checkout.`,
        );
      } else {
      ...
      <section className="py-20 px-6 text-center">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {plans.map((plan) => (
            <div
              key={plan.id}
              className={`glass rounded-2xl p-8 text-left relative ${
            ...
            >
              ...
              <button
                ...
                className={`w-full py-3 rounded-lg font-semibold mb-8 transition-all ${
                  plan.popular ? "btn-primary" : "bg-gray-800 hover:bg-gray-700"
                } disabled:opacity-50`}
              >
          ...
          <div className="space-y-6">
            <div className="glass rounded-xl p-6">
              ...
              <p className="text-gray-400">
                ...
                effect immediately and we'll prorate your billing.
              </p>
            </div>
            <div className="glass rounded-xl p-6">
              ...
              <p className="text-gray-400">
                We accept all major credit cards, PayPal, Pay Later, and bank
                transfers for annual plans. Powered by PayPal for secure
                payments.
              </p>
            </div>
            <div className="glass rounded-xl p-6">
