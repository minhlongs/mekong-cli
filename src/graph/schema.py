...
"""
Database Schema for Behavior Graph Service.

Uses PostgreSQL JSONB for flexible attribute storage.
Adjacency list pattern for graph edges.
GIN indexes for efficient JSONB querying.
"""

# Schema SQL for creating behavior graph tables
...
CREATE TRIGGER update_graph_trust_updated_at BEFORE UPDATE ON graph_trust
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
...
__all__ = ["SCHEMA_SQL", "MIGRATION_001"]
