    ...
    def _init_hints_catalog(self) -> None:
        ...
        self._hints_catalog: Dict[str, List[Hint]] = {
            ...
            "workspace_created": [
                ...
                Hint(
                    hint_id="configure_agents_tip",
                    category="workspace",
                    title="Configure Your Agents",
                    message="Set up autonomous agent pipelines to run your departments 24/7.",
                    action_url="/dashboard/workspace/agents",
                    action_label="Configure Agents",
                    priority=3,
                ),
            ],
            "llm_configured": [
