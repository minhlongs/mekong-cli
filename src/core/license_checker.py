...
class LicenseChecker:
    ...
    def _get_upgrade_hint(current_tier: LicenseTier, feature: str) -> str:
        ...
        if current_tier == LicenseTier.FREE:
            return "Upgrade to Pro for parallel execution and all task profiles: https://www.mekongmind.com/pricing"
        if current_tier == LicenseTier.PRO:
            return "Upgrade to Enterprise for custom agents and priority queue: https://www.mekongmind.com/pricing"
        return ""
