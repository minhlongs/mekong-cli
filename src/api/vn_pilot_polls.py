...
async def poll_response(
  ...
  """Capture poll response from authenticated tenant.

  NPS poll responses require a valid Bearer token resolved by
  require_tenant — endpoint no longer unauthenticated.
  """
