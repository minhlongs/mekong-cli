---
name: careful-mode
description: Block destructive commands when working with production systems. Activate with /careful. Blocks rm -rf, DROP TABLE, force-push, docker rm, kubectl delete, and live trading commands. Deactivate with /careful-off.
user-invocable: true
when_to_use: "Invoke when user needs safety guardrails against destructive operations — before rm commands, database drops, force pushes, container deletions, or live trading actions."
category: dev-tools
keywords: [safety, destructive, guardrails, production, protection]
---
