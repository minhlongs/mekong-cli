...
```bash
python3 .claude/_integration/skills/ui-ux-pro-max/scripts/search.py "<product-type>" --domain product
python3 .claude/_integration/skills/ui-ux-pro-max/scripts/search.py "<style-keywords>" --domain style
python3 .claude/_integration/skills/ui-ux-pro-max/scripts/search.py "<mood>" --domain typography
python3 .claude/_integration/skills/ui-ux-pro-max/scripts/search.py "<industry>" --domain color
```
