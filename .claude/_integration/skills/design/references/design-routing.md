...
**Brand:**
```bash
node .claude/_integration/skills/brand/scripts/inject-brand-context.cjs
node .claude/_integration/skills/brand/scripts/validate-asset.cjs <path>
```

**Tokens:**
```bash
node .claude/_integration/skills/design-system/scripts/generate-tokens.cjs -c tokens.json
node .claude/_integration/skills/design-system/scripts/validate-tokens.cjs -d src/
```
