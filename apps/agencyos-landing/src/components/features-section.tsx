export function FeaturesSection() {
  const features = [
    {
      title: "RaaS Credits",
      description: "Unified credit system for all AI services. Pay once, use everywhere across the AgencyOS ecosystem.",
      icon: (
    ...
    },
    {
      ...
      description: "Turnkey infrastructure for scaling agencies. Includes CRM, billing, project management, and client portal.",
      icon: (
        <svg className="h-6 w-6 text-indigo-600 dark:text-indigo-400" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
    ...
    {
      title: "Marketplace",
      description: "Access a library of proven 'Recipes' - pre-built agentic workflows for sales, marketing, and operations.",
      icon: (
        <svg className="h-6 w-6 text-indigo-600 dark:text-indigo-400" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center mb-16">
          ...
          <p className="mt-6 text-lg leading-8 text-slate-600 dark:text-slate-400">
            AgencyOS provides the infrastructure layer for modern, AI-first agencies. Focus on results, not boilerplate.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-16 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => (
              <div key={feature.title} className="flex flex-col items-start">
                <div className="rounded-lg bg-white dark:bg-slate-800 p-2 shadow-sm ring-1 ring-slate-900/5 dark:ring-slate-100/10 mb-6">
                  {feature.icon}
                </div>
                <h3 className="text-xl font-semibold leading-7 text-slate-900 dark:text-white mb-2">
                  {feature.title}
                </h3>
