...
describe('Landing Page', () => {
  ...
  beforeAll(() => {
    ...
    stylesCss = fs.readFileSync(path.join(rootDir, 'css/main.css'), 'utf8');
    scriptJs = fs.readFileSync(path.join(rootDir, 'js/menu.js'), 'utf8');
    navigationJs = fs.readFileSync(path.join(rootDir, 'js/navigation.js'), 'utf8');
  });
  ...
  describe('JavaScript Functionality', () => {
    ...
    test('should have mobile menu toggle', () => {
      expect(navigationJs).toContain('hamburger');
      expect(navigationJs).toContain('mobile-menu');
    });
    ...
    test('should have smooth scroll or navigation functionality', () => {
      ...
      const hasNavFunctionality = scriptJs.includes('scrollIntoView') ||
                                   ...
                                   navigationJs.includes('scrollIntoView');
