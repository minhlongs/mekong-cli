...
function stripAnsi(text) {
    return text.replace(/\x1B\[[0-9;]*[mGKHJF]/g, '')
...
const BUSY_PATTERNS = [
    ...
    /Simmering/i, /Glazing/i, /Caramelizing/i,
    /Mixing/i, /Measuring/i, /Whisking/i,
    /Basting/i, /Resting/i, /Grilling/i,
    /Zesting/i, /Seasoning/i, /Flipping/i,
    /Steaming/i, /Kneading/i, /Rolling/i,
    /Proofing/i, /Broiling/i, /Folding/i,
    /Metamorphosing/i, /Herding/i, /Elucidating/i,
];
...
const QUESTION_PATTERNS = [
    /Do you want to run/i, /Do you want to proceed/i,
    /\(y\/n\)/i, /\[y\/n\]/i,
    ...
    for (let i = 0; i < teamSize; i++) {
        try {
            const output = execSync(
                `tmux capture-pane -t ${TMUX_SESSION}:0.${i} -p 2>/dev/null`,
