 ...
 * UnifiedBridgeWidget
 * 
 * WOW Dashboard widget for AgencyOS Unified Bridge
...
export function UnifiedBridgeWidget() {
    ...
    const handleRefresh = async () => {
        ...
        // Simulate API call to get bridge status
        await new Promise(resolve => setTimeout(resolve, 500))
        setIsRefreshing(false)
    }

    const progressPercentage = ((rateLimit.max - rateLimit.remaining) / rateLimit.max) * 100
            ...
            <div className="mb-6 p-4 rounded-xl bg-neutral-900/50 border border-white/5">
                ...
                <div className="h-2 bg-neutral-700 rounded-full overflow-hidden mb-2">
                    <motion.div
                        ...
                        className={`h-full rounded-full ${progressPercentage > 80
