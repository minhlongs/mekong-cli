...
export default function RecruiterPage() {
    ...
    return (
        <MD3AppShell title="Recruiter Hub 👔" subtitle="Hiring • Candidates • Pipeline • Placements">
                ...
                supportingContent={
                    <MD3Card headline="Quick Actions" subhead="Recruiting Tools">
                        <div className="space-y-2">
                            {[{ icon: '👥', label: 'Candidates' }, { icon: '📋', label: 'Pipeline' }, { icon: '📅', label: 'Interviews' }, { icon: '🎯', label: 'Jobs' }, { icon: '📊', label: 'Reports' }, { icon: '⚙️', label: 'Settings' }].map((action) => (
