...
export default function ResearchPage() {
    ...
    return (
        <MD3AppShell title="Research Hub 🔬" subtitle="Studies • Analysis • Insights • Reports">
                ...
                supportingContent={
                    <MD3Card headline="Quick Actions" subhead="Research Tools">
                        <div className="space-y-2">
                            {[{ icon: '🔬', label: 'Studies' }, { icon: '📊', label: 'Data' }, { icon: '💡', label: 'Insights' }, { icon: '👥', label: 'Participants' }, { icon: '📋', label: 'Reports' }, { icon: '⚙️', label: 'Settings' }].map((action) => (
