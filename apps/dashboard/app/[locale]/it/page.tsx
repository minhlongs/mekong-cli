...
export default function ITPage() {
    ...
    return (
        <MD3AppShell title="IT Hub 💻" subtitle="Infrastructure • Support • Security • Systems">
                ...
                supportingContent={
                    <MD3Card headline="Quick Actions" subhead="IT Tools">
                        <div className="space-y-2">
                            {[{ icon: '🎫', label: 'Tickets' }, { icon: '🖥️', label: 'Systems' }, { icon: '🔒', label: 'Security' }, { icon: '📊', label: 'Monitor' }, { icon: '👥', label: 'Users' }, { icon: '⚙️', label: 'Settings' }].map((action) => (
