...
export function useAgentSocket(options: UseAgentSocketOptions = {}) {
    ...
    useEffect(() => {
        ...
        setAgents([
            { id: '1', name: 'Scout Agent', status: 'online', lastActive: new Date(), xp: 15420, tasks: 234 },
            { id: '2', name: 'Guardian Agent', status: 'busy', lastActive: new Date(), xp: 12850, tasks: 189 },
            { id: '3', name: 'Portfolio Agent', status: 'online', lastActive: new Date(), xp: 11200, tasks: 156 },
            { id: '4', name: 'Revenue Agent', status: 'idle', lastActive: new Date(), xp: 9800, tasks: 123 },
        ])
