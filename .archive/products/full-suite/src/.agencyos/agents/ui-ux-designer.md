...
python3 $HOME/.agencyos/skills/ui-ux-pro-max/scripts/search.py "<mood>" --domain typography
python3 $HOME/.agencyos/skills/ui-ux-pro-max/scripts/search.py "<industry>" --domain color
```
