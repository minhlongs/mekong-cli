...
- [What are skills?](https://support.agencyos.com/en/articles/12512176-what-are-skills)
- [Using skills in Claude](https://support.agencyos.com/en/articles/12512180-using-skills-in-claude)
- [How to create custom skills](https://support.agencyos.com/en/articles/12512198-creating-custom-skills)
...
To use any skill from this repository or upload custom skills, follow the instructions in [Using skills in Claude](https://support.agencyos.com/en/articles/12512180-using-skills-in-claude#h_a4222fa77b).

## Claude API

You can use Anthropic's pre-built skills, and upload custom skills, via the Claude API. See the [Skills API Quickstart](https://docs.agencyos.com/en/api/skills-guide#creating-a-skill) for more.
...
The markdown content below contains the instructions, examples, and guidelines that Claude will follow. For more details, see [How to create custom skills](https://support.agencyos.com/en/articles/12512198-creating-custom-skills).
