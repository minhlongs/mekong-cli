...
def find_api_key() -> Optional[str]:
    ...
    2. .agencyos/skills/ai-multimodal/.env (skill-specific config)
    3. .agencyos/skills/.env (shared skills config)
    4. .agencyos/.env (Claude global config)
    """
    ...
    if load_dotenv:
        ...
        skill_dir = script_dir.parent  # .agencyos/skills/ai-multimodal
        skills_dir = skill_dir.parent   # .agencyos/skills
        claude_dir = skills_dir.parent  # .agencyos
...
def find_project_root() -> Path:
    ...
    # Look for .git or .agencyos directory
