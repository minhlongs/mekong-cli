...
1. Visit [mekongmind.com](https://mekongmind.com)
...
Visit [mekongmind.com/dashboard](https://mekongmind.com/dashboard) and enter your credentials.
...
This opens NOWPayments checkout in your browser.

### Buy via Dashboard

1. Log in to [mekongmind.com/dashboard](https://mekongmind.com/dashboard)
2. Navigate to **Billing → Upgrade**
3. Select your tier and complete payment via NOWPayments
...
**A:** Contact support@mekongmind.com with your mission ID. We process refunds within 24 hours for legitimate issues.

### Q5: Can I use RaaS for multiple projects?

**A:** Yes. Your credit pool covers all projects. Submit missions across any department under a single subscription.
...
**A:** NOWPayments handles payments. We accept all major credit cards, Apple Pay, and Google Pay.

### Q10: Where do I get support?

**A:** Email support@mekongmind.com for technical issues. Response time: 24 hours (4 hours for Enterprise customers).
...
4. **Contact Sales**: Enterprise customers reach out to sales@mekongmind.com
