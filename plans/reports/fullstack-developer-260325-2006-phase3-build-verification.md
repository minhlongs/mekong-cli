...
- Secrets must be set before live deploy: `JWT_SECRET`, `POLAR_WEBHOOK_SECRET`, `TELEGRAM_BOT_TOKEN`, `SERVICE_TOKEN`, `RESEND_API_KEY`, `STRIPE_SECRET_KEY`, `STRIPE_WEBHOOK_SECRET`
