...
- Set secrets via `wrangler secret put` if not already set: JWT_SECRET=REDACTED, POLAR_WEBHOOK_SECRET, TELEGRAM_BOT_TOKEN, SERVICE_TOKEN, RESEND_API_KEY, STRIPE_SECRET_KEY, STRIPE_WEBHOOK_SECRET
