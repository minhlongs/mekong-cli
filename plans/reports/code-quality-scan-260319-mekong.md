...
| File | Pattern | Risk |
|------|---------|------|
| `src/auth/config.py` | `JWT_SECRET_KEY`, `STRIPE_SECRET_KEY` | Env vars (acceptable) |
| `src/auth/session_manager.py:22` | `JWT_SECRET = os.getenv("JWT_SECRET", secrets.token_urlsafe(32))` | Fallback secret in code |
