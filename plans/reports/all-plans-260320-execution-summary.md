...
- **Phase 2:** Fallback secrets removal (fail-fast on missing JWT_SECRET=REDACTED)
...
2. ⏳ Set raas-gateway secrets (`JWT_SECRET=REDACTED`, `POLAR_WEBHOOK_SECRET`, `SERVICE_TOKEN`)
