...
1. **Session Manager JWT handling** (`src/auth/session_manager.py`) properly uses `pyjwt` with signature verification, HS256, and enforces `JWT_SECRET` in production
