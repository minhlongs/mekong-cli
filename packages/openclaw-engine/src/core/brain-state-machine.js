...
const BUSY_PATTERNS = [
	...
	/Reducing/i,
	/Blanching/i,
	/[*·✢✻✽✳✶]\s*(?:Thinking|Compacting|Galloping|Reading|Writing|Executing|Running|Starting|Gusting|Whirring|Boondoggling|Pondering|Synthesizing|Refining|Actioning|Investigating|Analyzing|Exploring)/i,
	/Churning/i,
	/Cooking/i,
	/Toasting/i,
	/Galloping/i,
