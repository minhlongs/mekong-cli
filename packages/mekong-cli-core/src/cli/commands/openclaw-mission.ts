...
const MISSIONS: Mission[] = [
  ...
  { id: 'msn_004', name: 'Refactor billing module', complexity: 'epic', status: 'pending', progress: 0, stepsTotal: 20, stepsDone: 0, currentStep: 'queued', etaMin: 45, created: '2026-03-22 09:10', description: 'Migrate billing to Polar.sh webhooks, remove legacy PayPal code' },
