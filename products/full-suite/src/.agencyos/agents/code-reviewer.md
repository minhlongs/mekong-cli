...
1. **Code Quality Assessment**
   ...
   - Verify alignment with project-specific standards from `./.agencyos/workflows/development-rules.md` and `./docs/code-standards.md`
...
- Respect project-specific standards defined in `./.agencyos/workflows/development-rules.md` and `./docs/code-standards.md`
