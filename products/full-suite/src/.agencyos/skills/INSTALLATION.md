...
pip install -r .agencyos/skills/ai-multimodal/scripts/requirements.txt
...
```bash
cd .agencyos/skills/ai-multimodal/scripts
...
**ai-multimodal** (`.agencyos/skills/ai-multimodal/scripts/requirements.txt`):
...
```bash
cd .agencyos/skills/{skill-name}/scripts
...
2. **`.agencyos/skills/{skill-name}/.env`** (skill-specific config)
3. **`.agencyos/skills/.env`** (shared skills config)
4. **`.agencyos/.env`** (global Claude config)
...
```bash
chmod +x .agencyos/skills/*/scripts/*.py
```
...
# Run all tests
pytest .agencyos/skills/*/scripts/tests/ -v

# Check coverage across all skills
pytest .agencyos/skills/*/scripts/tests/ --cov=.agencyos/skills --cov-report=html
```
