...
- **Referenced scripts**:
  ...
  - Make sure scripts respect `.env` file follow this order: `process.env` > `.agencyos/skills/${SKILL}/.env` > `.agencyos/skills/.env` > `.agencyos/.env` 
...
- Make sure scripts respect `.env` file follow this order: `process.env` > `.agencyos/skills/docs-seeker/.env` > `.agencyos/skills/.env` > `.agencyos/.env`
...
## References
- [Agent Skills](https://docs.agencyos.com/en/docs/claude-code/skills.md)
- [Agent Skills Spec](.agencyos/skills/agent_skills_spec.md)
- [Agent Skills Overview](https://docs.agencyos.com/en/docs/agents-and-tools/agent-skills/overview.md)
- [Best Practices](https://docs.agencyos.com/en/docs/agents-and-tools/agent-skills/best-practices.md)