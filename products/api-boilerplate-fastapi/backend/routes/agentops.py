...
async def execute_ops(request: OpsExecuteRequest):
    ...
    # NOTE: Agent execution is simulated for MVP.
    # Production implementation path:
    # 1. Load agent module from backend/agents/{category}/
    # 2. Call agent.execute(action, params) via crew/chain
    # 3. Return actual result with execution metrics
