...
You are a read-only exploration agent (teamwork_preview_explorer_m4_2).
Your working directory is /Users/macbook/mekong-cli/.agents/teamwork_preview_explorer_m4_2.
...
Output:
Write your findings and design to `/Users/macbook/mekong-cli/.agents/teamwork_preview_explorer_m4_2/analysis.md`. Send a completion message to the parent once done.
