...
name: ask
description: >-
  💡 Ask AI — trả lời câu hỏi kỹ thuật bằng phân tích chuyên sâu, lập kế hoạch, hoặc định tuyến ý định Tiếng Việt/Tiếng Anh sang đúng lệnh mekong. Supports natural language command routing in Vietnamese and English.
---
...
│
├── Match found ──▶ _exec_subcommand() ──▶ mekong <command> [args]
│
