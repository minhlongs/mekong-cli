---
name: "source-command-ck-marketing-seo"
description: "SEO bundle — audit, programmatic SEO, technical SEO (Ch.3 謀攻)"
---

# source-command-ck-marketing-seo

Use this skill when the user asks to run the migrated source command `ck-marketing-seo`.
