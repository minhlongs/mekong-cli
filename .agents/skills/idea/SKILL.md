...
name: idea
description: >-
  Agentic BizPlan OS — Generate full company architecture from a business idea. Adapted from mekong-cli /idea for Antigravity. Auto-execute 25 steps, Zero→IPO.
---
