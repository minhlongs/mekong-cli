---
name: "source-command-antibridge"
description: "Access AntiBridge skill for mobile AI agent control"
---

# source-command-antibridge

Use this skill when the user asks to run the migrated source command `antibridge`.
