---
name: "source-command-raas-ops-health-sweep"
description: "Run operational health checks across systems. 1 command, ~15-20 min."
---

# source-command-raas-ops-health-sweep

Use this skill when the user asks to run the migrated source command `raas-ops-health-sweep`.
