---
name: "source-command-ck-marketing-local"
description: "Local business marketing bundle — schema markup, local SEO (Ch.10 地形)"
---

# source-command-ck-marketing-local

Use this skill when the user asks to run the migrated source command `ck-marketing-local`.
