...
name: palette
description: >-
  🔍 Command Palette — fuzzy search mekong commands by typing natural language. Vietnamese + English. Part of Warp-style TUI layer.
---
...
3. **Enter** → execute matched command via `mekong <command>`
