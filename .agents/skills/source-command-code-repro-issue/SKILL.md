---
name: "source-command-code-repro-issue"
description: "Create reproducible test case for GitHub issue"
---

# source-command-code-repro-issue

Use this skill when the user asks to run the migrated source command `code-repro-issue`.
