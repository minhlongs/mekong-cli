---
name: "source-command-docs-add-changelog"
description: "Add entry to changelog following Keep a Changelog format"
---

# source-command-docs-add-changelog

Use this skill when the user asks to run the migrated source command `docs-add-changelog`.
