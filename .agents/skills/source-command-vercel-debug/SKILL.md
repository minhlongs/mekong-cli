---
name: "source-command-vercel-debug"
description: "Debug Vercel CI/CD deployments — check status, fix errors, verify production GREEN"
---

# source-command-vercel-debug

Use this skill when the user asks to run the migrated source command `vercel-debug`.
...
See `.Codex/rules/cc-cli-input-rules.md` — Input MUST end with `\n`.
...
*Ported from claudekit ~/.Codex/commands/vercel-debug.md — 2026-04-16*
