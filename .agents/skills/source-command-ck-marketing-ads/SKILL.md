---
name: "source-command-ck-marketing-ads"
description: "Paid advertising bundle — ad strategy, copy, A/B testing (Ch.2 作戰)"
---

# source-command-ck-marketing-ads

Use this skill when the user asks to run the migrated source command `ck-marketing-ads`.
