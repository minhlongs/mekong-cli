...
license: MIT
version: 1.0.0
why-override: "Mekong description is more elaborate + activation-trigger-aware than the older stock at ~/.Codex/skills/llm-fine-tuning-mlops. Mekong is canonical here."
---
