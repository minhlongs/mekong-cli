---
name: "source-command-ck-marketing-cro"
description: "CRO bundle — landing page, form, checkout optimization (Ch.4 形勢)"
---

# source-command-ck-marketing-cro

Use this skill when the user asks to run the migrated source command `ck-marketing-cro`.
...
```
Read skill: ~/.Codex/skills/marketing/skills/page-cro/SKILL.md
Analyze target page
