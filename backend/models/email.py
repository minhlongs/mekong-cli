...
class DripEnrollment(Base):
    ...
    current_step_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("email_campaign_steps.id"), nullable=True
    )
...
class EmailLog(Base):
    ...
    subscriber_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("email_subscribers.id"), nullable=True
    )
    campaign_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("email_campaigns.id"), nullable=True
    )
