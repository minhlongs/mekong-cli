...
class SignatureService:
    ...
    @staticmethod
    def generate_hmac_signature(payload: Union[str, bytes], secret: str, algorithm: str = 'sha256') -> str:
        """
    ...
    @staticmethod
    def verify_hmac_signature(payload: Union[str, bytes], secret: str, signature: str, algorithm: str = 'sha256') -> bool:
        """
    ...
    @staticmethod
    def verify_ed25519_signature(payload: Union[str, bytes], public_key_pem: str, signature: str) -> bool:
        """
    ...
    @staticmethod
    def verify_rsa_signature(payload: Union[str, bytes], public_key_pem: str, signature: str) -> bool:
        """
