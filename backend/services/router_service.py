...
class RouterService:
    ...
    def __init__(self):
        self.routing_strategy = {
            ...
            TaskType.CODE: {
                ...
                Complexity.MEDIUM: {"provider": "anthropic", "model": "claude-3-haiku", "cost": 0.02},
            ...
            TaskType.CREATIVE: {
                ...
                Complexity.MEDIUM: {"provider": "anthropic", "model": "claude-3-sonnet", "cost": 0.08},
    ...
    def _generate_reason(self, task_type: TaskType, complexity: Complexity, config: Dict[str, Any]) -> str:
