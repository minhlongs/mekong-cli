...
class PDFGenerator:
    ...
    def generate_executive_report(
        ...
        if insights:
            for insight in insights:
                ...
                elements.append(Paragraph(f"• {insight}", self.styles['InsightText'], bulletText="•"))
    ...
    def _create_revenue_chart(self, trends: List[Dict[str, Any]]) -> Drawing:
        ...
        lc.xValueAxis.labelTextFormat = lambda x: "" # Hide X labels for simplicity or format properly
