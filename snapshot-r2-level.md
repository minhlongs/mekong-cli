            ...
            - generic [ref=e252]:
              ...
              - generic [ref=e334]:
                ...
                - generic [ref=e337]:
                  ...
                  - generic [ref=e1065]:
                    - generic [ref=e1066]:
                      - generic [ref=e1067]: Resources
                      - button "Resources" [ref=e1069] [cursor=pointer]: Account
                    - generic [ref=e1071]:
                      - generic [ref=e1072]: Permissions
                      - combobox [ref=e1073]:
                        - textbox "Permissions" [ref=e1074]:
                          - /placeholder: Select
                          - text: Workers R2 Storage
                        - button [ref=e1075] [cursor=pointer]
                    - generic [ref=e1078]:
                      - generic [ref=e1080]: option Read focused, 1 of 2. 2 results available. Use Up and Down to choose options, press Enter to select the currently focused option, press Escape to exit the menu, press Tab to select the option and exit the menu.
                      - generic [ref=e1082]:
                        - generic [ref=e1083]: Select...
                        - combobox "Permissions levels" [expanded] [active] [ref=e1084]:
                          - generic [ref=e1092]:
                            - generic [ref=e1093] [cursor=pointer]: Read
                            - generic [ref=e1094] [cursor=pointer]: Edit
