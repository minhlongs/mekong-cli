"""
AntigravityKit - The WOW Toolkit for Southeast Asian Solo Agency Owners

Features:
- Vietnamese-first experience
- Module-first architecture (KuckIt pattern)
- AI agent crew system (ClaudeKit pattern)
- Binh Phap business strategy framework
