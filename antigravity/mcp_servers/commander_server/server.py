...
logger = logging.getLogger("commander-server")
...
class CommanderMCPServer:
    ...
    def run(self):
        ...
        logger.info("Commander MCP Server started")
    ...
    def call_tool(self, name: str, args: Dict[str, Any]) -> Any:
        ...
        if name == "get_dashboard":
            return asyncio.run(self.handler.get_dashboard())

        elif name == "check_system":
            system_name = args.get("system_name")
            return asyncio.run(self.handler.check_system(system_name))
