...
class TestAgentRegistry(unittest.TestCase):
    ...
    def test_register_invalid_agent_warns(self):
        """Test registering non-AgentBase class warns but still registers."""
        class NotAnAgent:
            pass

        self.test_registry.register("invalid", NotAnAgent)
        # Should be registered despite not being AgentBase
        self.assertIn("invalid", self.test_registry.list_agents())
