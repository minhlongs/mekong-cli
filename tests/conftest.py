...
_pre_gateway_patches = [
    ...
    # NOTE: event_bus, EventType, OrchestrationResult, raas_router, Scheduler
    # are NOT auto-patched here — tests need the real classes. Other tests that
    # need a mock set their own patch() locally.
    ("src.api.tier_config_routes.router", MagicMock(routes=[])),
    # NOTE: quota_status_endpoints is NOT auto-patched — test_api_endpoints.py
    # needs the real router. Gateway test mocks it locally.
]
