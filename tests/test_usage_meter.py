...
from engine.payments.usage_meter import UsageMeter, get_meter
from engine.license.license_generator import get_tier_limits
...
class TestUsageMeterQuotaValidation:
    ...
    async def test_record_usage_with_valid_quota(self) -> None:
        ...
        with patch("engine.payments.usage_meter.get_repository") as mock_repo:
