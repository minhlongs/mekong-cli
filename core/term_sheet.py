"""
📋 Term Sheet Analyzer - Fundraising Intelligence
==================================================

Analyze and understand term sheets.
Inspired by Pillar VC's Term Sheet Grader.
...
if __name__ == "__main__":
    tsa = TermSheetAnalyzer("Saigon Digital Hub")
    
    print("📋 Term Sheet Analyzer")
    print("=" * 60)
    print()
    
    print(tsa.format_dashboard())
