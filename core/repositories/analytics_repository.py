...
try:
    from ..services.analytics_service import ClientMetrics, MetricPeriod, RevenueEntry, RevenueType
except ImportError:
...
class AnalyticsRepository:
    ...
    def generate_demo_data(self) -> bool:
        ...
        try:
            ...
            logger.info(
                f"Generated {len(revenue_entries)} revenue entries and {len(client_metrics)} client records"
            )
            return success
        except Exception as e:
