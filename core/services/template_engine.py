...
class TemplateEngine:
    ...
    def render_proposal(self, variables: Dict[str, Any]) -> str:
        ...
        required_vars = ["client_name", "project_name", "project_description", 
                        "services_list", "setup_fee", "monthly_fee", "timeline",
                        "calendar_link", "owner_name", "agency_name"]
        self._validate_variables(required_vars, variables)
    ...
    def render_payment_thanks(self, variables: Dict[str, Any]) -> str:
        ...
        required_vars = ["client_name", "amount", "project_name", "next_invoice_date", 
