...
class AnalyticsCalculationEngine:
    ...
    def calculate_client_overview(
        self,
        client_metrics: Dict[str, ClientMetrics]
    ) -> Dict[str, Any]:
    ...
    def calculate_revenue_breakdown(
        ...
        return {
            ...
            "by_type": by_type,
            "by_client": by_client,
            "recurring_ratio": sum(e.amount for e in period_entries if e.recurring) / max(1, sum(e.amount for e in period_entries))
        }
